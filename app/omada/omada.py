...
class Omada:
	...
	def updateWirelessNetwork(self, group, ssid, site=None, data={}):
		site = self.site_key( site )
		self.patch(f'/sites/{site}/setting/wlans/{group}/ssids/{ssid}',json=data)
